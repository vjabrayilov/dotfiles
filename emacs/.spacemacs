  ...
  (setq-default
   ...
   '(
     ...
     (syntax-checking :variables
                      syntax-checking--fringe-indicator t)
     ;; version-control
     tmux
     (tree-sitter :variables
                  tree-sitter-syntax-highlight-enable t
                  )
     evil-better-jumper ;; better-jump C-o backwards, C-i forward
     themes-megapack
     (rust :variables
           lsp-rust-analyzer-cargo-auto-reload t
           rustic--get-line-number t
   ...
   dotspacemacs-frozen-packages '(gruvbox-theme)

   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(zonokai-emacs code-review)

   ;; Defines the behaviour of Spacemacs when installing packages.
   ;; Possibl(e val :variables c-c++-backend 'lsp-clangd)ues are `used-only', `used-but-keep-unused' and `all'.
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; spacemacs-light)
   dotspacemacs-themes '(doom-dark+ wombat gruvbox gruvbox-dark-hard solarized-gruvbox-dark solarized-gruvbox-light)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (with-eval-after-load 'quelpa-build
    (setq quelpa-build-explicit-tar-format-p t
          quelpa-build-tar-executable (or (executable-find "gtar")
                                          (executable-find "tar"))))
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link afternoon-theme aggressive-indent aidermacs alect-themes alert
                all-the-icons ample-theme ample-zen-theme amx anti-zenburn-theme
                apropospriate-theme auto-compile auto-highlight-symbol
                auto-yasnippet autothemer avy-jump-helm-line badwolf-theme
                better-jumper birds-of-paradise-plus-theme bubbleberry-theme bui
                busybee-theme catppuccin-theme centered-cursor-mode
                cherry-blossom-theme chocolate-theme claude-code-ide
                clean-aindent-mode closql clues-theme
                color-theme-sanityinc-solarized color-theme-sanityinc-tomorrow
                column-enforce-mode company company-c-headers cond-let counsel
                counsel-projectile cpp-auto-include cyberpunk-theme dakrone-theme
                ...
                elisp-slime-nav emacsql emr esh-help eshell-prompt-extras eshell-z
                ...
                farmhouse-themes flatland-theme flatui-theme flx flycheck
                flycheck-elsa flycheck-package flycheck-pos-tip flyspell-correct
                flyspell-correct-helm flyspell-correct-ivy forge gandalf-theme
                ...
                gruber-darker-theme gruvbox-theme hc-zenburn-theme helm helm-ag
                helm-c-yasnippet helm-comint helm-company helm-core helm-descbinds
                ...
                hungry-delete hybrid-mode indent-guide info+ inkpot-theme
                inspector ir-black-theme ivy ivy-avy ivy-hydra ivy-purpose
                ivy-xref ivy-yasnippet jazz-theme jbeans-theme kaolin-themes
                launchctl light-soap-theme link-hint llama log4e lorem-ipsum
                lsp-docker lsp-ivy lsp-mode lsp-origami lsp-treemacs lsp-ui
                lush-theme macrostep madhat2r-theme magit magit-section
                magit-todos markdown-mode markdown-toc material-theme
                ...
                omtose-phellack-themes open-junk-file org-category-capture
                org-cliplink org-contrib org-download org-mime org-pomodoro
                org-present org-project-capture org-projectile org-rich-yank
                org-superstar organic-green-theme orgit orgit-forge origami
                osx-clipboard osx-dictionary osx-trash overseer package-lint
                page-break-lines paradox password-generator pcre2el
                phoenix-dark-mono-theme phoenix-dark-pink-theme planet-theme
                popwin pos-tip professional-theme purple-haze-theme quickrun
                railscasts-theme rainbow-delimiters rebecca-theme restart-emacs
                reveal-in-osx-finder reverse-theme ron-mode rust-mode rustic
                ...
                space-doc spacegray-theme spacemacs-purpose-popwin
                ...
                term-cursor terminal-here toc-org toml-mode toxi-theme transient
                tree-sitter tree-sitter-indent tree-sitter-langs treemacs-evil
                treemacs-icons-dired treemacs-magit treemacs-persp
                treemacs-projectile treepy tsc twilight-anti-bright-theme
                twilight-bright-theme twilight-theme ujelly-theme underwater-theme
                undo-fu undo-fu-session uuidgen vi-tilde-fringe
                volatile-highlights vterm vundo wfnames wgrep white-sand-theme
